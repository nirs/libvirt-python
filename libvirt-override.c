...
static PyObject *
libvirt_virDomainListCheckpoints(PyObject *self ATTRIBUTE_UNUSED,
                                 PyObject *args)
{
    PyObject *py_retval = NULL;
    ...
    if (!PyArg_ParseTuple(args, (char *)"OI:virDomainListCheckpoints",
                          &pyobj_dom, &flags))
        return NULL;
    dom = (virDomainPtr) PyvirDomain_Get(pyobj_dom);

    LIBVIRT_BEGIN_ALLOW_THREADS;
    c_retval = virDomainListCheckpoints(dom, &chks, flags);
    LIBVIRT_END_ALLOW_THREADS;
...
static PyObject *
libvirt_virDomainCheckpointListChildren(PyObject *self ATTRIBUTE_UNUSED,
                                        PyObject *args)
{
    PyObject *py_retval = NULL;
    virDomainCheckpointPtr *chks = NULL;
    ...
    if (!PyArg_ParseTuple(args, (char *)"OI:virDomainCheckpointListChildren",
                          &pyobj_parent, &flags))
        return NULL;
    parent = (virDomainCheckpointPtr) PyvirDomainCheckpoint_Get(pyobj_parent);

    LIBVIRT_BEGIN_ALLOW_THREADS;
    c_retval = virDomainCheckpointListChildren(parent, &chks, flags);
    LIBVIRT_END_ALLOW_THREADS;
...
#endif /* LIBVIR_CHECK_VERSION(1, 0, 3) */
#if LIBVIR_CHECK_VERSION(5, 1, 0)
    {(char *) "virDomainListCheckpoints", libvirt_virDomainListCheckpoints, METH_VARARGS, NULL},
    {(char *) "virDomainCheckpointListChildren", libvirt_virDomainCheckpointListChildren, METH_VARARGS, NULL},
#endif /* LIBVIR_CHECK_VERSION(5, 1, 0) */
